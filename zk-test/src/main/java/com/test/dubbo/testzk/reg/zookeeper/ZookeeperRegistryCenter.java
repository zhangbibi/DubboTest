...
import com.test.dubbo.testzk.reg.exception.RegExceptionHandler;
...
public final class ZookeeperRegistryCenter implements CoordinatorRegistryCenter {
    ...
    @Override
    public void init() {
        System.out.println("Elastic job: zookeeper registry center init, server lists is: {}." + zkConfig.getServerLists());
